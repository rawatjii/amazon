                    ...
                    <div className="card">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <input type="text" value={currentProduct.id} className="form-control" hidden />
                                <div className="form-group">
                                    <label htmlFor="">Product Name</label>
                                    <input type="text" className="form-control" value={currentProduct.product_title} />
                                </div>
                            ...
                            <div className="d-flex gap-3 py-3">
                                ...
                                <div>0 reviews</div>
                                <div className="text-success"><i className='bx bxs-cart-alt align-middle'></i> 0 orders</div>
                            </div>
                            <div className="mb-3"> 
